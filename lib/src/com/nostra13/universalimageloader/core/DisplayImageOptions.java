 ...
 * <ul>
 * <li>whether stub image will be displayed in {@link com.nostra13.universalimageloader.core.imageaware.ImageAware image
 ...
 * @since 1.0.0<br>
 *        指导每一个Imageloader根据网络图片的状态（空白、下载错误、正在下载）显示对应的图片，是否将缓存加载到磁盘上，下载完后对图片进行怎么样的处理。 <br>
 *        E.g.<br>
 *        DisplayImageOptions options = new DisplayImageOptions.Builder()<br>
 *        .showImageOnLoading(R.drawable.ic_stub) // resource or drawable<br>
 *        .showImageForEmptyUri(R.drawable.ic_empty) // resource or drawable<br>
 *        .showImageOnFail(R.drawable.ic_error) // resource or drawable<br>
 *        .resetViewBeforeLoading(false) // default<br>
 *        .delayBeforeLoading(1000)<br>
 *        .cacheInMemory(false) // default<br>
 *        .cacheOnDisk(false) // default<br>
 *        .preProcessor(...)<br>
 *        .postProcessor(...)<br>
 *        .extraForDownloader(...)<br>
 *        .considerExifParams(false) // default<br>
 *        .imageScaleType(ImageScaleType.IN_SAMPLE_POWER_OF_2) // default<br>
 *        .bitmapConfig(Bitmap.Config.ARGB_8888) // default<br>
 *        .decodingOptions(...)<br>
 *        .displayer(new SimpleBitmapDisplayer()) // default<br>
 *        .handler(new Handler()) // default<br>
 *        .build();<br>
 */
public final class DisplayImageOptions {
    ...
    public static class Builder {
        ...
        /**
         * Stub image will be displayed in {@link com.nostra13.universalimageloader.core.imageaware.ImageAware image
         * aware view} during image loading
         * 
         * @param imageRes
         *            Stub image resource
        ...
        /**
         * Incoming image will be displayed in {@link com.nostra13.universalimageloader.core.imageaware.ImageAware image
         * aware view} during image loading
         * 
         * @param imageRes
         *            Image resource
         ...
         * image aware view} during image loading. This option will be ignored if
        ...
        /**
         * Incoming image will be displayed in {@link com.nostra13.universalimageloader.core.imageaware.ImageAware image
         * aware view} if empty URI (null or empty string) will be passed to <b>ImageLoader.displayImage(...)</b>
         * method.
         * 
         * @param imageRes
         *            Image resource
        ...
        /**
         * Incoming drawable will be displayed in {@link com.nostra13.universalimageloader.core.imageaware.ImageAware
         * image aware view} if empty URI (null or empty string) will be passed to <b>ImageLoader.displayImage(...)</b>
         * method. This option will be ignored if {@link DisplayImageOptions.Builder#showImageForEmptyUri(int)} is set.
         */
        ...
        /**
         * Incoming image will be displayed in {@link com.nostra13.universalimageloader.core.imageaware.ImageAware image
         * aware view} if some error occurs during requested image loading/decoding.
         * 
         * @param imageRes
         *            Image resource
         */
        ...
        /**
         * Incoming drawable will be displayed in {@link com.nostra13.universalimageloader.core.imageaware.ImageAware
         * image aware view} if some error occurs during requested image loading/decoding. This option will be ignored
         * if {@link DisplayImageOptions.Builder#showImageOnFail(int)} is set.
         */
        ...
        /**
         * {@link com.nostra13.universalimageloader.core.imageaware.ImageAware image aware view} will be reset (set
        ...
        /**
         * Sets whether {@link com.nostra13.universalimageloader.core.imageaware.ImageAware image aware view} will be
         ...
         * {@link com.nostra13.universalimageloader.core.imageaware.ImageAware image aware view} but after they'll have
         * been saved in memory cache.
         */

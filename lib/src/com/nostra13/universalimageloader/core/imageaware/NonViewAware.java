...
/**
 * ImageAware which provides needed info for processing of original image but do nothing for displaying image. It's used
 * when user need just load and decode image and get it in
 ...
 * @since 1.9.0
 * 
 *        ImageAware 提供处理原始图像，但不对显示图像做任何处理
 */

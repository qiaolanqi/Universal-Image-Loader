...
public abstract class ViewAware implements ImageAware {
     ...
     *            <b>true</b> - then {@link #getWidth()} and {@link #getHeight()} will check actual size of View. It can
     *            cause known issues like <a
     *            href="https://github.com/nostra13/Android-Universal-Image-Loader/issues/376">this</a>. But it helps to
     *            save memory because memory cache keeps bitmaps of actual (less in general) size.
     *            <p/>
     *            <b>false</b> - then {@link #getWidth()} and {@link #getHeight()} will <b>NOT</b> consider actual size
     *            of View, just layout parameters. <br />
     *            If you set 'false' it's recommended 'android:layout_width' and 'android:layout_height' (or
     *            'android:maxWidth' and 'android:maxHeight') are set with concrete values. It helps to save memory.
     */
     ...
     * {@inheritDoc}
     * <p/>
     * Width is defined by target {@link android.view.View view} parameters, configuration parameters or device display
     * dimensions.<br />
     ...
     * {@inheritDoc}
     * <p/>
     * Height is defined by target {@link android.view.View view} parameters, configuration parameters or device display
     * dimensions.<br />
     * Size computing algorithm (go by steps until get non-zero value):<br />
    ...
    public boolean setImageDrawable(Drawable drawable) {
        if (Looper.myLooper() == Looper.getMainLooper()) {// 当前为主线程
            View view = viewRef.get();
            if (view != null) {
